...
- **Setec prefix**: Gateway client adds `remotejuggler/` prefix. Use bare names
...
# Store scan results
juggler_setec_put(name="scans/hexstrike/latest", value="{...}")

# Check identity
juggler_status()

# Report credential exposure finding
# Always reference by name, never extract the actual secret value
```

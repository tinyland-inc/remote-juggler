...
| Docker | `ghcr.io/tinyland-inc/remote-juggler:v2.2.0` |
| npm | `npx @tummycrypt/remote-juggler@beta` |
| Nix | `nix profile install github:tinyland-inc/remote-juggler/v2.2.0` |
...
```
ec470e5fe08ef35a96685c218cf1a91fe6caf92503bb6535651103513fd180d7  remote-juggler-2.2.0-1.x86_64.rpm
...
754c551f0ceaeae482e9239141dcf2d0c47b6a9a399ba8755c2f9b62773411ad  remote-juggler-gui-v2.2.0-x86_64.AppImage
...
0c837274294a94a0ea6b778f91d4723ff6a4929c9afb4a679c07670d8b8b7a02  remote-juggler_2.2.0_amd64.deb
```
